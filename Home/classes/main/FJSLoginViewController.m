...
- (void)userLogin:(UIButton *)loginBtn
{
    ...
    NSString *urlStr = @"http://10.150.236.246/home/user/userLogin";
    
    [MBProgressHUD showMessage:@"正在登录中"];
    
    [FJSApiRequest postRequestWithUrl:urlStr bodyDict:bodyDict tagert:self okSel:@selector(loginSuccess:) errorSel:@selector(loginError:) failSel:@selector(loginFail:)];
    
}

- (void)loginSuccess:(id)responseData
{
